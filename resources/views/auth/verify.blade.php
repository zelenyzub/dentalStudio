                    ...
                    <div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
                        ...
                        <div class="card shadow-sm">
                            <div class="card-header">
                                <h3 class="card-title">VERIFIKACIJA NALOGA</h3>
                            </div>
                            <div class="card-body">
                                @if (session('resent'))
                                    <div class="alert alert-success" role="alert">
                                        {{ __('Novi verifikacioni mail uspešno poslat') }}
                                    </div>
                                @endif
                                Pre nego što nastavite potrebno je da verifikujete nalog. Odlaskom na Vaš e-mail i potvrdom naloga ova verifikacija biće završena.
                            </div>
                            <div class="card-footer">
                                Ako niste dobili mail za verifikaciju kliknite na link ispod.
                                <form class="d-inline" method="POST" action="{{ route('verification.resend') }}">
                                    @csrf
                                    <button type="submit" class="btn btn-link p-0 m-0 align-baseline">{{ __('kliknite za slanje novog verifikacionog mail-a') }}</button>.
                                </form>
                            </div>
                        </div>
                        <!--end::Form-->
